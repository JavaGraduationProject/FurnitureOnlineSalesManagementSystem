...
<html>
	...
	<div class="search-title">
		...
		<div class="description">
			<a
				href="${pageContext.request.contextPath}/admin/spcategorymanager.do?actiontype=get&forwardurl=/admin/sitenavguide.jsp">选择商品导航</a>
			|<a
				href="${pageContext.request.contextPath}/admin/sitenavmanager.do?actiontype=load">自定义导航</a>
		</div>
	</div>
	<!-- 搜索控件开始 -->
		...
		<tbody>
			...
			<tr>
				<td>&nbsp<input id="chk<%=temsitenav.getId()%>" class="check"
					name="snid" type="checkbox" value='<%=temsitenav.getId()%>'></td>
