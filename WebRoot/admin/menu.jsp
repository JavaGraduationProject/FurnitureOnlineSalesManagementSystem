   ...
   <div class="sidebar-item">
        ...
        <ul class="sidebar-trans fn-show">
            <li>
             ...
             <li>
                ...
                <div class="sidebar-navtext">
                    ...
                    <span class="nav-title">
                       <a target="main" href="${pageContext.request.contextPath}/admin/shangpinmanager.do?actiontype=load">发布商品</a>
            ...
            <li>
                ...
                <div class="sidebar-navtext">
                    ...
                    <span class="nav-title">
                       <a target="main" href="${pageContext.request.contextPath}/admin/caigoumanager.do?actiontype=get"> </a>
             ...
             <li>
                ...
                <div class="sidebar-navtext">
                    ...
                    <span class="nav-title">
                        ...
                        <a target="main" href="${pageContext.request.contextPath}/admin/supplyormanager.do?actiontype=get"> </a>
    ...
    <div class="sidebar-item">
        <div class="sidebar-title">
            ...
            <span class="sidebar-title-icon  fa fa-arrow-circle-down"></span>
            <span class="sider-bar-title-text">商品标签管理</span>
            ...
            <li>
                ...
                <div class="sidebar-navtext">
                    ...
                    <span class="nav-title">
                        ...
                        <a target="main" href="${pageContext.request.contextPath}/admin/spcategorymanager.do?actiontype=get&forwardurl=/admin/spcategorymanager.jsp">商品类别管理</a>
              ...
              <li>
                ...
                <div class="sidebar-navtext">
                    ...
                    <span class="nav-title">
                        ...
                        <a target="main"  href="${pageContext.request.contextPath}/admin/hytypemanager.do?actiontype=get">会员类型管理</a>
