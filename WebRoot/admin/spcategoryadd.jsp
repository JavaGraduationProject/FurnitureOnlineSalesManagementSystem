  ...
  <title>商品类别</title>
   ...
   <script type="text/javascript">
		...
		$("#hidTupian").val("/upload/temp/"+file.name);
			          ...
			          var imgtupiansrc="${requestScope.spcategory.tupian}";
				       if(imgtupiansrc==""){
				    ...
				    <form name="spcategoryform"  method="post" action="${pageContext.request.contextPath}/admin/spcategorymanager.do"  id="spcategoryForm">
				        <table class="grid" cellspacing="1" width="100%">
						        ...
						        <input type="hidden" name="actiontype" value="${actiontype}" />
						         ...
						         <input type="hidden" name="errorurl" value="/admin/spcategoryadd.jsp" />
						        <input type="hidden" name="forwardurl" value="/admin/spcategorymanager.do?actiontype=get&forwardurl=/admin/spcategorymanager.jsp" />
						        <tr>
								  <td colspan="4">
								      ${errormsg}
								  </td>
											   ...
											   <td>
												    <img id="imgTupian" width="200px" height="200px"  src="${pageContext.request.contextPath}${requestScope.spcategory.tupian}"/>
												    	<div>
													        <input type="file" name="upload" id="btnulTupian" />
													    </div>
													 <input type="hidden" id="hidTupian" name="tupian" value="${requestScope.spcategory.tupian}" />
												</td>
											   </tr>
						   <tr>
						       <td colspan="4">
