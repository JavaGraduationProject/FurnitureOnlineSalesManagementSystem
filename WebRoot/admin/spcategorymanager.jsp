...
<html>
	...
	<div class="search-title">
		...
		<div class="description">
			<a
				href="${pageContext.request.contextPath}/admin/spcategorymanager.do?actiontype=load&forwardurl=/admin/spcategoryadd.jsp">新建商品类别</a>
		</div>
	</div>
	<!-- 搜索控件开始 -->
				...
				<tbody>
					<tr>
						<td>名称 <input name="mingcheng" value="${mingcheng}"
							...
							value="/admin/spcategorymanager.jsp" />
		...
		<tbody>
			...
			<tr>
				...
				<td><a class="orange-href"
					href="${pageContext.request.contextPath}/admin/spcategorymanager.do?actiontype=load&id=<%=temspcategory.getId()%>&forwardurl=/admin/spcategoryadd.jsp">修改</a>
