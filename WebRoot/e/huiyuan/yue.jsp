...
<body>
	...
	<div class="wrap round-block">
		<div class="line-title">
			当前位置：<a href="/jiaju/e/index.jsp">首页</a> &gt;&gt; 账户余额
		</div>
		   ...
		   <div class="main">
		       ...
		       <div class="main-content">
				...
				<div class="shang_box">
					...
					<div class="pay_explain">扫码充值</div>
					...
					<div>
						<form name="chongzhiForm"
							...
							<input type="hidden" name="id" value="${huiyuan.id}" /> <input
								type="hidden" name="actiontype" value="chongzhi" /> <input
								name="jine" type="hidden" value="5000" /> <input type="hidden"
